const { serviceGmailClient, buildEmailFooter } = require('#shared/email/email.instance')
...
const sendBackchargeViaEmail = async (email, supplierName = '', recipientName = '', attachments = [], equipment = '') => {
  ...
  return serviceGmailClient.sendEmail(email, subject, htmlContent, textContent, attachments)
}
