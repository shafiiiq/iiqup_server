...
router.get(
  '/:mechanicId/monthly-overtime',
  controller.getMechanicMonthlyOvertime
);
router.get(
  '/:mechanicId/monthly-overtime/:month/:year',
  controller.getMechanicMonthlyOvertime
);
...
router.get(
  '/attendance/:zktecoPin/weekly/:year/:week',
  controller.getWeeklyAttendance
);
router.get(
  '/attendance/:zktecoPin/monthly/:year/:month',
  controller.getMonthlyAttendance
);
router.get(
  '/attendance/:zktecoPin/yearly/:year',
  controller.getYearlyAttendance
);
router.get(
  '/attendance/:zktecoPin/date-range',
  controller.getAttendanceByDateRange
);
...
router.get(
  '/attendance/:zktecoPin/all-months',
  controller.getAllMonthsAttendance
);
router.get(
  '/attendance/:zktecoPin/all-years',
  controller.getAllYearsAttendance
);
...
router.delete(
  '/:mechanicId/overtime/cleanup',
  controller.cleanupMechanicOvertimeData
);
