...
class DevController {
  ...
  static async addExperience(req, res) {
    try {
      const experience = await portfolioService.addExperience(req.body);
      res.status(201).json({
        success: true,
        data: experience,
  ...
  static async updateExperience(req, res) {
    try {
      const experience = await portfolioService.updateExperience(req.params.id, req.body);
      if (!experience) {
  ...
  static async deleteExperience(req, res) {
    try {
      const experience = await portfolioService.deleteExperience(req.params.id);
      if (!experience) {
        return res.status(404).json({
          success: false,
          message: 'Experience not found'
  ...
  static async addProject(req, res) {
    try {
      const project = await portfolioService.addProject(req.body);
      res.status(201).json({
        success: true,
        data: project,
  ...
  static async addSkill(req, res) {
    try {
      const skill = await portfolioService.addSkill(req.body);
      res.status(201).json({
        success: true,
        data: skill,
  ...
  static async updateSkill(req, res) {
    try {
      const skill = await portfolioService.updateSkill(req.params.id, req.body);
      if (!skill) {
        return res.status(404).json({
          success: false,
  ...
  static async deleteSkill(req, res) {
    try {
      const skill = await portfolioService.deleteSkill(req.params.id);
      if (!skill) {
        return res.status(404).json({
          success: false,
          message: 'Skill not found'
  ...
  static async addEducation(req, res) {
    try {
      const education = await portfolioService.addEducation(req.body);
      res.status(201).json({
        success: true,
        data: education,
  ...
  static async updateEducation(req, res) {
    try {
      const education = await portfolioService.updateEducation(req.params.id, req.body);
      if (!education) {
        return res.status(404).json({
          success: false,
  ...
  static async deleteEducation(req, res) {
    try {
      const education = await portfolioService.deleteEducation(req.params.id);
      if (!education) {
        return res.status(404).json({
          success: false,
          message: 'Education not found'
  ...
  static async addCertificate(req, res) {
    try {
      const certificate = await portfolioService.addCertificate(req.body);
      res.status(201).json({
        success: true,
        data: certificate,
  ...
  static async updateCertificate(req, res) {
    try {
      const certificate = await portfolioService.updateCertificate(req.params.id, req.body);
      if (!certificate) {
        return res.status(404).json({
          success: false,
  ...
  static async deleteCertificate(req, res) {
    try {
      const certificate = await portfolioService.deleteCertificate(req.params.id);
      if (!certificate) {
        return res.status(404).json({
          success: false,
          message: 'Certificate not found'
  ...
  static async addService(req, res) {
    try {
      const service = await portfolioService.addService(req.body);
      res.status(201).json({
        success: true,
        data: service,
  ...
  static async updateService(req, res) {
    try {
      const service = await portfolioService.updateService(req.params.id, req.body);
      if (!service) {
        return res.status(404).json({
          success: false,
  ...
  static async deleteService(req, res) {
    try {
      const service = await portfolioService.deleteService(req.params.id);
      if (!service) {
        return res.status(404).json({
          success: false,
          message: 'Service not found'
  ...
  static async updateStats(req, res) {
    try {
      const stats = await portfolioService.updateStats(req.body);
      res.status(200).json({
        success: true,
        data: stats,
  ...
  static async getContact(req, res) {
    try {
      const contact = await portfolioService.getContact();
      res.status(200).json({
        success: true,
        data: contact
      });
  ...
  static async updateContact(req, res) {
    try {
      const contact = await portfolioService.updateContact(req.body);
      res.status(200).json({
        success: true,
        data: contact,
