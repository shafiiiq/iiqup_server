...
router.post('/add-maintenance-history', serviceHistoryController.addMaintananceHistory)
...
router.get('/get-service-history-by/:serviceType/:id', serviceHistoryController.getServiceHistoryById)
router.get('/get-maintenance-history/:regNo', serviceHistoryController.getMaintananceHistory)
