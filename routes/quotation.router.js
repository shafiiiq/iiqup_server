...
const controller = require('../controllers/quotation.controllers');
...
router.get   ('/get-quotations-by-company/:vendorName',      controller.getquotationsByCompany);
...
router.get   ('/get-quotation-of-all-equipments',            controller.getquotationsForAllEquipments);
...
// ── Email ─────────────────────────────────────────────────────────────────────
router.post  ('/send-via-email', upload.fields([{ name: 'pdf', maxCount: 1 }, { name: 'attachments', maxCount: 10 }]), controller.sendquotationViaEmail);
