...
const stocksModel = require('../stock/stock.model.js');
const equipmnentModel = require('../equipment/equipment.model.js');
const toolkitModel = require('../toolkit/toolkit.model.js');
const complaintModel = require('../complaint/complaint.model.js');
const mobilizationModel = require('../equipment/mobilizations.model.js');
const replacementModel = require('../equipment/replacements.model.js');
const lpoModel = require('../lpo/lpo.model.js');
const backchargeModel = require('../backcharge/backcharge.model.js');
const documentModel = require('../document/document.model.js');
